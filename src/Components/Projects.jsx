    ...
    <>
      <div className="flex flex-col items-center  justify-center lg:gap-8">
        <div className="mb-20 lg:flex md:my-[15%] lg:mb-36 lg:my-[5%] lg:mx-10">
          <div className="flex items-center justify-center lg:w-[100%] lg:mr-16 mb-10 gap-7 md:gap-0 lg:gap-5 mx-auto p-2">
            ...
            <motion.img
              ...
              src={fash2}
              alt="middle"
              className="w-[45%] md:w-[37%] lg:w-[45%] h-80 relative -top-2 left-40 rounded-xl"
            />
            <motion.img
              src={fash1}
              alt="right"
              className="w-[50%] md:w-[42%] lg:w-[50%] h-80  z-50 rounded-xl"
            />
            <motion.img
              style={{ transformOrigin: "bottom" }}
              variants={imgRight}
              ...
              src={fash3}
              alt="left"
              className="w-[45%] md:w-[37%] lg:w-[45%] h-80 relative -top-2 right-40 rounded-xl"
            />
          </div>

          <div>
            <h2 className="text-2xl md:text-3xl lg:text-4xl mx-4 my-4 md:mt-16 md:mb-5">
              Shopping site
            </h2>
            <p className="text-lg md:text-xl lg:text-2xl mx-4 my-4">
        ...
        <div className="mb-20 lg:flex">
          <div className="flex items-center justify-center lg:w-[100%] lg:mr-16 mb-10 gap-7 md:gap-0 lg:gap-5 mx-auto p-2 lg:mx-10">
            {" "}
            {/*Square card   lg:flex img */}
            <motion.img
              style={{ transformOrigin: "bottom" }}
            ...
            <motion.img
              src={res2}
              alt="right"
              className="w-[50%] md:w-[42%] lg:w-[50%] h-80  z-50 rounded-xl border-black border"
            />
            <motion.img
              style={{ transformOrigin: "bottom" }}
              variants={imgRight}
